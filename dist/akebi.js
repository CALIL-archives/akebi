...
var _app = require('./component/parts/app.jsx');
  ...
  function _class(divId, akebiOption) {
    ...
    .end(function (error, res) {
      if (!error) {
        ...
        this.react = _reactDom2.default.render(_react2.default.createElement(_app2.default, options), document.getElementById(divId));
      }
    }.bind(this));
  }
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = {};
    _this.width = parseFloat(_this.props.width) || undefined;
    _this.height = parseFloat(_this.props.height) || undefined;
    return _this;
  }
